...
namespace arc{
    ...
    OpenGLShader::OpenGLShader(std::string file_path) {
    ...
    void OpenGLShader::Compile(const std::unordered_map<uint, std::string> &shader_sources) {
...
// Always detach shaders after a successful link.
    ...
    void OpenGLShader::SetFragOutput(unsigned int color, const std::string &name) {
